...
* [🤖 Linux](linux/README.md)
  ...
  * [日志查询](linux/ri-zhi-cha-xun/README.md)
    ...
    * [文本搜索 Ripgrep](linux/ri-zhi-cha-xun/wen-ben-sou-suo-ripgrep.md)
    * [goaccess 解析日志文件](linux/ri-zhi-cha-xun/goaccess-jie-xi-ri-zhi-wen-jian.md)
    * [ripgrep 筛选指定时间范围日志](linux/ri-zhi-cha-xun/ripgrep-shai-xuan-zhi-ding-shi-jian-fan-wei-ri-zhi.md)
  ...
  * [OpenSSH Slow: Hanging at SSH2\_MSG\_SERVICE\_ACCEPT received](linux/openssh-slow-hanging-at-ssh2\_msg\_service\_accept-received.md)
...
* [🍎 Mac](mac/README.md)
  * [MacOS 浏览器播放音频没声音](mac/macos-liu-lan-qi-bo-fang-yin-pin-mei-sheng-yin.md)
  ...
  * [start apache\_server](mac/start-apache\_server.md)
...
* [🖥 Windows](windows/README.md)
  * [命令行获取电脑的序列号](windows/ming-ling-hang-huo-qu-dian-nao-de-xu-lie-hao.md)
...
* [Hetzner](hetzner/README.md)
  ...
  * [hetzner\_box](hetzner/hetzner\_box.md)
